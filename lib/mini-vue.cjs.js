...
function createRenderer(options) {
    ...
    function patch(prevNode, currNode, container, parentInstance) {
        // ShapeFlags
    ...
    function processFragment(prevNode, currNode, container, parentInstance) {
    ...
    function processElement(prevNode, currNode, container, parentInstance) {
        if (!prevNode) {
    ...
    function patchElement(prevNode, currNode, container, parentInstance = null) {
        // TODO: patch props
    ...
    function patchChildren(prevNode, currNode, container, parentInstance) {
    ...
    function processComponent(prevNode, currNode, container, parentInstance) {
